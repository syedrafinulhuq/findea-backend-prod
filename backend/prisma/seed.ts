...
async function main() {
  ...
  const products = [
    ...
    { slug: 'tapered-wool-trousers',     name: 'Tapered Wool Trousers',       description: 'Slim-tapered dress trousers in heather-grey wool blend with a flat front.',          price: 185.00, stock: 12, categoryId: man.id,         imageUrl: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?q=80&w=800&auto=format&fit=crop' },
    ...
    { slug: 'slim-denim-jeans-indigo',   name: 'Slim Denim Jeans – Indigo',   description: 'Slim-fit indigo raw-selvedge denim with a tapered leg and five-pocket styling.',     price: 160.00, stock: 18, categoryId: man.id,         imageUrl: 'https://images.unsplash.com/photo-1542272604-787c3835535d?q=80&w=800&auto=format&fit=crop' },
    ...
    { slug: 'linen-drawstring-pants',    name: 'Linen Drawstring Pants',      description: 'Relaxed linen trousers with an elasticated drawstring waist and side seam pockets.', price:  98.00, stock: 20, categoryId: man.id,         imageUrl: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=800&auto=format&fit=crop' },
    ...
    // ── SHOES (10 new) ──────────────────────────────────────────────────────────
    { slug: 'white-canvas-sneakers',     name: 'White Canvas Sneakers',       description: 'Clean minimal canvas trainers with a vulcanised rubber sole and cotton laces.',       price:  85.00, stock: 35, categoryId: shoes.id,       imageUrl: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=800&auto=format&fit=crop' },
    { slug: 'block-heel-sandals-tan',    name: 'Block Heel Sandals – Tan',    description: 'Leather block-heel sandals with an ankle strap and a cushioned footbed.',            price: 138.00, stock: 15, categoryId: shoes.id,       imageUrl: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?q=80&w=800&auto=format&fit=crop' },
    ...
    { slug: 'mesh-running-sneakers',     name: 'Mesh Running Sneakers',       description: 'Breathable knit-mesh running shoes with a responsive foam midsole and heel clip.',   price: 148.00, stock: 25, categoryId: shoes.id,       imageUrl: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=800&auto=format&fit=crop' },
    ...
    { slug: 'tan-oxford-shoes',          name: 'Oxford Shoes – Tan',          description: 'Hand-stitched cap-toe oxford shoes in tan calfskin — polished everyday versatility.', price: 248.00, stock:  8, categoryId: shoes.id,       imageUrl: 'https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?q=80&w=800&auto=format&fit=crop' },
    ...
    { slug: 'kids-striped-tee',          name: 'Kids Striped T-Shirt',        description: 'Organic cotton Breton-striped tee in classic navy and white.',                        price:  28.00, stock: 35, categoryId: kids.id,        imageUrl: 'https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?q=80&w=800&auto=format&fit=crop' },
    { slug: 'kids-woollen-cardigan',     name: 'Kids Woollen Cardigan',       description: 'Soft lambswool cardigan with wooden toggle closures in warm oat.',                   price:  65.00, stock: 18, categoryId: kids.id,        imageUrl: 'https://images.unsplash.com/photo-1522771930-78848d9293e8?q=80&w=800&auto=format&fit=crop' },
    ...
    { slug: 'kids-floral-blouse',        name: 'Kids Floral Blouse',          description: 'Printed chiffon blouse with a peter pan collar and puffed short sleeves.',           price:  45.00, stock: 20, categoryId: kids.id,        imageUrl: 'https://images.unsplash.com/photo-1519689373023-dd07c7988603?q=80&w=800&auto=format&fit=crop' },
    ...
    { slug: 'kids-corduroy-pants',       name: 'Kids Corduroy Pants',         description: 'Slim-fit corduroy trousers in forest green with elasticated waistband.',             price:  52.00, stock: 24, categoryId: kids.id,        imageUrl: 'https://images.unsplash.com/photo-1522771930-78848d9293e8?q=80&w=800&auto=format&fit=crop' },
  ];
